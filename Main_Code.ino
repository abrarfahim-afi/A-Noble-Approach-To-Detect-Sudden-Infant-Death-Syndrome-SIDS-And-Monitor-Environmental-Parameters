        ...
        if(ECG_Difference <= ECG_threshold)
        {
          ...
          tft.println();
            if(sumTime_ECG>= 10000.0){
              //for(int i=0; i<=5; i++){digitalWrite(buzzer_pin,HIGH); delay(300); digitalWrite(buzzer_pin,LOW);}
        ...
        if(Flex_read_Difference <= Flex_threshold)
        {
          ...
          tft.println();
            if(sumTime_Flex>= 10000.0){
              //for(int i=0; i<=5; i++){digitalWrite(buzzer_pin,HIGH); delay(300); digitalWrite(buzzer_pin,LOW);} // For Buzzer
                if(Flex_SMSstatus==0){ Flex_SMSsend();Flex_SMSstatus=1;} //For notification
            }  
          }
...
// For Serial Monitor and Serila Plotter Illustration 
    ...
    Serial.print(" Flex Diff: ");Serial.print(Flex_read_Difference);
